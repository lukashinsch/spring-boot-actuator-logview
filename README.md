...
![Maven Central](https://maven-badges.herokuapp.com/maven-central/eu.hinsch/spring-boot-actuator-logview/badge.svg)
...
Gradle
```groovy
compile 'eu.hinsch:spring-boot-actuator-logview:0.2.1'
```
Note
